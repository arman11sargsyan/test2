...
class ProfileFieldSections
{
	...
	const YOUR_PROFILE = 'Y';
	const VENDORS_BILLING_INFORMATION = 'V';
    ...
    public static function getAll($lang_code = CART_LANGUAGE)
    {
        return [
			...
			self::YOUR_PROFILE          => __('your_profile', [], $lang_code),
			self::VENDORS_BILLING_INFORMATION          => __('vendors_billing_information', [], $lang_code),
