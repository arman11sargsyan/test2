...
<form action="{""|fn_url}" name="shopify_merchant_search_form" method="get">
...
{include file="common/advanced_search.tpl" simple_search=$smarty.capture.simple_search dispatch=$dispatch view_type="wk_shopify" in_popup=$in_popup advanced_search=false}
