...
$config['db_name'] = 'restore_db';
$config['db_user'] = 'restore_user';
$config['db_password'] = 'restore4321';
...
$config['http_host'] = 'restore.ecomdev.co.uk';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'restore.ecomdev.co.uk';
$config['https_path'] = '';
...
if( $config['http_host'] == 'restore.ecomdev.co.uk'  )
{
    //define('DEVELOPMENT', true);
}