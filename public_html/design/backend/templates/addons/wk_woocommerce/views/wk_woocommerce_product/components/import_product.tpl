...
{* {cm-ajax cm-comet} *}
<form action="{""|fn_url}" method="post" enctype="multipart/form-data" class="form-horizontal form-edit" name="woocommerce_import_products_form">
<div style="padding:10px;">
    ...
    <div class="buttons-container buttons-container-picker">
            ...
            {include file="buttons/button.tpl" but_role="submit" but_name="dispatch[wk_woocommerce_product.list_collection_products]" but_target_form="woocommerce_import_products_form"  but_text=__("import") but_meta="btn btn-primary cm-submit cm-dialog-closer" but_id="import_product_btn"}
    </div>
</div>
</form>
