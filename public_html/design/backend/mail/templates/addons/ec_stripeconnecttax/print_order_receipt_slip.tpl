...
<tr>
    ...
    <div style="background-color: #ffffff; margin: 0px auto; padding: 0px 44px 0px 46px; width: 510px; text-align: left;">
...
<tr><td>&nbsp;</td></tr>
        ...
        {* Customer info *}
		{assign var="vendor_country_full_name" value=$company_billing_info.vendorcountry|fn_get_country_descriptions:$smarty.const.CART_LANGUAGE}
        {assign var="vendor_state_full_name" value=$company_billing_info.vendorcountry|fn_get_state_descriptions:$company_billing_info.vendorstate}
        ...
        <tr>
            <td style="width: 50%; padding: 14px 0px 0px 2px;">
			 <h3 style="font:bold 16px Tahoma; margin: 0px 0px 10px 0px;">{__("ec_stripeconnecttax_paid_by")}</h3>
                ...
                {$company_billing_info.vendorcity}<br />{$vendor_state_full_name} {$company_billing_info.vendorzipcode}<br />
                {$vendor_country_full_name}
...
{assign var="state_full_name" value=$settings.Company.company_country|fn_get_state_descriptions:$settings.Company.company_state}
            <td style="padding-top: 14px;" valign="top">
                ...
                {$settings.Company.company_city}<br />{$state_full_name}  {$settings.Company.company_zipcode}<br />
                {$country_full_name}
            </td>
        </tr>
        </table>
        ...
        {* /Ordered products *}
            ...
            <table style="direction: {$language_direction};">
                ...
                <tr>
                    <td>
                        <div style="padding-left: 7px; padding-bottom: 15px; overflow-x: auto; clear: both; width: 505px; height: 100%; padding-bottom: 20px; overflow-y: hidden;font-size:11px;">{__('vendorinformation_orderreceipt_summary_bottommsg')}</div>
                    </td>
                </tr>
				<tr>
                    <td>
